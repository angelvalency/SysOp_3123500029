...
- **Nilai positif**: Dikembalikan ke parent atau call. Nilai tersebut berisi ID proses dari proses anak yang baru dibuat.
...
- `fork02.c`
   ...
   -  Deskripsi <br>
    Didalam visualisasi fork diatas meruapakan hasil dari output dimana menampilkan loop `PID` dengan 2 kali perulangan integer `4379` dan `4380` sebagai process ID `(PID)` dimana pada child pertama akan menghasilkan `PPID` = `PID parent process`. Loop dapat dihentingakn dengan `CTRL-Z`
...
- `fork03.c`
   ...
   -  Deskripsi <br>
    Didalam visualisasi fork diatas meruapakan hasil dari output dimana menampilkan loop `PID` sebanyak 10 kali perulangan integer `4421` dan `4422` sebagai process ID `(PID)` dari parents process dimana pada child pertama akan menghasilkan `PPID` = `PID parent process`. Loop dapat dihentingakn dengan `CTRL-Z`
